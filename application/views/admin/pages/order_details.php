                    ...
                    <tbody>
                        ...
                        foreach ($order_details_info as $single_order_details) {
                            ...
                            <tr>
                                ...
                                <td>MWK<?php echo $this->cart->format_number($single_order_details->product_price)?> </td>
                                <td><?php echo $single_order_details->product_sales_quantity ?></td>
                                <td>MWK<?php echo $this->cart->format_number($single_order_details->product_price * $single_order_details->product_sales_quantity) ?></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                    <tfooter>
                        <td colspan="5">Total Amount</td>
                        <td>= MWK<?php echo $this->cart->format_number($order_info->order_total)?> </td>
                    </tfooter>
                </table>            
            </div>
        </div><!--/span-->
